package com.learning.sparkdataengg.HybridProcessing;
...
public class LongLastActionExtractorJob {
    ...
    public static void main(String[] args) {
        ...
        extractLongAction("2022-05-03", "2022-05-04");
    }
    ...
    private static void extractLongAction(String startDate, String endDate) {
        ...
        try {
            ...
            System.out.println("Running long last action extraction for period " + startDate + " to " + endDate);
            ...
            System.out.println("Bounds for the Query are " + minBounds + " and " + maxBounds);
