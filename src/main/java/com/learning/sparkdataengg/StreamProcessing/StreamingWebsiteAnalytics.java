package com.learning.sparkdataengg.StreamProcessing;
...
public class StreamingWebsiteAnalytics {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("******** Initiating Streaming Website Analytics *************");
        ...
        //Thread - To Initiate the Kafka Website Visits Generator
        ...
        try {
            // Define schema of the incoming record
                    ...
                    .foreach(
                            new ForeachWriter<Row>() {
                                ...
                                @Override public void process(Row record) {
                                    System.out.println("Retrieved Visit Record : " + record.toString() );
                                }
            ...
            Dataset<Row> shoppingCartDf = visitsDf.filter( "lastAction == 'ShoppingCart'");
            ...
            shoppingCartDf
                    ...
                    .writeStream()
                    .format("kafka")
                    .option("checkpointLocation", "tmp/cp-shoppingcart3")
                    .option("kafka.bootstrap.servers", "localhost:9092")
            ...
            // Write the 5 seconds window summary to MariaDB in real time
            windowedSummary
                    .writeStream()
